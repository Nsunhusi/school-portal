...
<script>
    ...
    errorx(x);
          ...
          echo '<form onsubmit="ggo(\'in\');return false" action="#" method=\'POST\' class="validate-form sign-up-form">
          <div class="lloader"></div>
          <div class="error_note"></div>
          <h2 class="title">Instructors Sign in</h2>
          <div class="input-field">
    ...
    <div class="panels-container">
      ...
      <div class="panel right-panel">
        <div class="content">
          <h3>Not An Instructor?</h3>
          <p>If You Are Not An Instructor Sign In Here</p>
          <button onclick='window.location = this.getAttribute("href")' href='student' class="btn transparent" id="sign-in-btn">
            Sign in
          </button>
        </div>
